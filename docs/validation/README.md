...
| VAL-02 — PSP capability decision | Open | Legal + Finance + Engineering | [#2](https://github.com/lazymarcus005-maker/carespaces/issues/2) |
...
| VAL-07 — Identity/KYC provider selection | Open | Product + Legal + Engineering | [#7](https://github.com/lazymarcus005-maker/carespaces/issues/7) |
